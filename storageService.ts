...
export const storageService = {
  getStats: async (): Promise<{ urls: ShortUrl[], stats: AnalyticsStats }> => {
    try {
      ...
      // Fix for line 36: removed invalid shorthand cast 'value as number' to resolve syntax error
      ...
      return {
        ...
        stats: {
          ...
          dailyClicks,
          countryStats,
          recentClicks: clicks.slice(0, 10).map((c: any) => ({
            id: c.id,
            urlId: c.url_id,
      ...
      return { urls: [], stats: { totalClicks: 0, uniqueUrls: 0, topCountry: 'None', dailyClicks: [], countryStats: [], recentClicks: [] } };
    }
  },
